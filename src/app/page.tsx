  ...
  return (
    <section className="container  m-auto flex flex-col items-center justify-center gap-8 py-16 md:py-24 text-center">
      <div className="flex max-w-3xl flex-col items-center gap-6">
         ...
         src="/logo-no-bg.png"
          ...
          className="h-auto mb-4 relative top-10" // Added margin bottom
                    priority
                  />
        <h1 className="text-4xl !text-blue-50 font-extrabold leading-tight tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl">
          Welcome to <span className="bg-gradient-to-r from-yellow-100 to-orange-100 bg-clip-text text-transparent">BlogSmith</span>
        </h1>
        <p className="max-w-[700px] text-lg sm:text-xl !text-blue-50"> {/* text-slate-300 removed, global style will apply */}
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-4">
        ...
        <Button asChild variant="outline" size="lg" className="border-yellow-200 !text-blue-50 !!hover:text-white hover:bg-yellow-200 transition duration-300  hover:scale-105">
